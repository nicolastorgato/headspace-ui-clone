...
const HomepageHeroGuest = () => {
    return (
        ...
        <div className='flex flex-col md:flex-row items-center mb-14 xl:mb-10 2xl:pb-12 2xl:pt-8 2xl:dark:bg-black mx-12 xl:mx-64'>   
            <div className="w-full xl:w-1/2 py-8 sm:pt-20 2xl:py-20 flex flex-col justify-center items-start">
                <h1 className="lg:text-7xl md:text-5xl sm:text-4xl text-4xl font-bold text-gray-700 dark:text-gray-200 mb-8">
                    Be kind to your mind, <br /> it will be fine
                </h1>
                <p className='mb-12 xl:mb-16 font-medium text-xl xl:text-2xl text-gray-500 dark:text-gray-300'>Less stressed. More resilient. Happier. <br/> It all starts with just a few minutes a day.</p>
                ...
                <div className='mt-8 text-gray-600 flex items-center'> 
                    <a href='www.google.it ' className=' mr-2 flex items-center'>
                        ...
                        <p className='text-gray-500 hover:text-orange'>See how it works </p> 
                    </a>
                </div>
            </div>
