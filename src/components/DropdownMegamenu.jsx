...
const DropdownMegamenu = () => {
    ...
    return (
        <>
            <ul 
                className='absolute w-full left-0 top-20 h-full'
                >
                ...
                <div className='flex px-40 pb-8 bg-white border-gray-200 border-t-2 border-b-4 rounded-b-3xl'>
                    <div className='flex flex-col py-4 justify-start items-start w-1/4 bg-white'>
                        ...
                        <a href='www.headspace.com' className='my-2 py-3 px-4 text-md underline flex items-center'> View All <FiArrowRight /> </a>
                    </div>
                    ...
                    <div className='flex flex-col py-4 justify-start items-start w-1/4 bg-white'>
                        ...
                        <ul className='my-2 py-2 px-4 text-sm'>
                            <li className='mb-4'> <a className='underline font-semibold tracking-wider' href="www.headspace.com"> How to form a habit </a> </li>
                            <li className='mb-4'> <a className='underline font-semibold tracking-wider' href="www.headspace.com"> What is Mindfulness? </a> </li>
                            <li className='mb-4'> <a className='underline font-semibold tracking-wider' href="www.headspace.com"> How to calm down </a> </li>
                            <li className='mb-4'> <a className='underline font-semibold tracking-wider' href="www.headspace.com"> Mindful Eating </a> </li>
                            <li className='mb-4'> <a className='underline font-semibold tracking-wider' href="www.headspace.com"> How to improve self-esteem </a> </li>
                        </ul>
                    </div>
