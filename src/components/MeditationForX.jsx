...
const MeditationForX = () => {
    ...
    return (
        <div className=' mb-12 mx-8 md:mx-16 lg:mx-24 xl:mx-36 2xl:mx-80'>
            <div className='py-10'>
                <h1 className='text-3xl xl:text-6xl font-bold text-gray-700' >Meditation and mindfulness for any mind, any mood, any goal </h1>
            </div>
            ...
            <div className='flex w-full'>
                <div className='w-1/2 py-10'>
                    <div className='grid grid-cols-2 gap-4 gap-y-16'>
                        <div className='col-span-1 flex flex-col'>
                            <h1 className='text-gray-500 text-4xl font-bold pb-6'>Meditation</h1>
                            <ul>
                        ...
                        <div className='col-span-1 flex flex-col'>
                            <h1 className='text-gray-500 text-4xl font-bold pb-6'>Sleep</h1>
                            <ul>
                        ...
                        <div className='col-span-1 flex flex-col'>
                            <h1 className='text-gray-500 text-4xl font-bold pb-6'>Stress</h1>
                            <ul>
                                <li id='meditationForX_1' className='py-1' onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}> 
                                    <a className='text-gray-700 text-md font-semibold underline opacity-50 hover:opacity-100 transition-opacity duration-1000 ease-out' 
                        ...
                        <div className='col-span-1 flex flex-col'>
                            <h1 className='text-gray-500 text-4xl font-bold pb-6'>Mindfulness</h1>
                            <ul>
                                <li id='meditationForX_6' className='py-1' onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}> 
                                    <a className='text-gray-700 text-md font-semibold underline opacity-50 hover:opacity-100 transition-opacity duration-1000 ease-out' 
                ...
                <div className='w-1/2 pt-10 pb-16 px-16'>
